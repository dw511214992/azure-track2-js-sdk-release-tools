...
export class ParameterDeclaration implements TypedDeclaration {
    constructor(public name: string, public type: string | undefined, public isOptional: boolean, public start?: number, public end?: number) { }
}
...
export class BoundParameterDeclaration extends ParameterDeclaration {
    ...
    constructor(private startCharacter: string, private endCharacter: string, isOptional: boolean, start?: number, end?: number) {
        super('', '', isOptional, start, end);
    }
}

export class ObjectBoundParameterDeclaration extends BoundParameterDeclaration {
    constructor(isOptional: boolean, start?: number, end?: number) {
        super('{', '}', isOptional, start, end);
    }
}
